...
use anchor_spl::token_interface::{self,TokenInterface, Mint, TokenAccount,MintTo,TransferChecked};
use anchor_spl::associated_token::AssociatedToken;

declare_id!("EasyK7sKbapvD8VyieEjdtdXDMxpA7BTQdH5dFfFDv6L");

#[program]
pub mod transfer_with_pda_token_account {
    use super::*;
    ...
    pub fn create_and_mint_tokens(ctx: Context<CreateAndMintTokens>, amount: u64) -> Result<()> {
        ...
        let cpi_context = CpiContext::new(cpi_program, cpi_account).with_signer(signer_seeds);
